 ...
 *
 * Polls Gmail and Outlook for replies to sent emails.
 * Gmail: checks thread for messages from recipient.
 * Outlook: queries conversation for messages from recipient.
