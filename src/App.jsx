...
export default function App() {
  // Config
  const [phase, setPhase] = useState('entry') // entry | settings | discover | companies | csv | contacts | drafting | review | schedule | macro
...
End Sub`
  ...
  // ── SETTINGS ────────────────────────────────────────────────────────────
  if (phase === 'settings') {
    const canContinue = senderName.trim() && senderEmail.trim()
    ...
    return (
      <div>
        ...
        {/* API Keys — managed server-side via .env */}
